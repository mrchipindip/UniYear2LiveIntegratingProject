...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            intent = new Intent(this, SymptomsListActivity.class);

        } else if (id == R.id.nav_calendar) {
            intent = new Intent(this, GraphAndCalendarActivity.class);

        } else if (id == R.id.nav_graph) {
            intent = new Intent(this, GraphAndCalendarActivity.class);

        } else if (id == R.id.nav_helpful_info) {
            intent = new Intent(this, MedRefActivity.class);
